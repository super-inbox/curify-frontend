...
// Gradient pairs per type (top → bottom)
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <span style={{ color: "#6b7280", fontSize: 18, letterSpacing: 2 }}>curify.ai</span>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", marginTop: 48 }}>
          ...
          <div style={{ fontSize: 34, color: "#c4b5fd", fontWeight: 700, marginTop: 16, letterSpacing: 0.5 }}>
            {meta.tagline}
          </div>
        ...
        <div style={{ display: "flex", gap: 16, marginTop: "auto", paddingTop: 32 }}>
          {shown.map((char) => (
            <div key={char.name} style={{ display: "flex", flexDirection: "column", flex: 1 }}>
              ...
              <div style={{ color: "#a78bfa", fontSize: 13, marginTop: 2 }}>{char.ip}</div>
            </div>
          ))}
          ...
          <div style={{
            ...
            <div style={{ color: "#e5e7eb", fontSize: 19, fontWeight: 700, lineHeight: 1.4 }}>
