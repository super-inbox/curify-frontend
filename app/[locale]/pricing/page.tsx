// New Pricing Page — Replaces Login Page UI
"use client";
...
export default function PricingPage() {
  return (
    <>
      <Head>
        <title>Pricing | Curify Studio</title>
      </Head>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="border rounded-lg p-6 shadow-sm">
              ...
              <p className="text-sm text-gray-600 mb-4">Receive <span className="font-semibold">100 C</span>/Month</p>
            ...
            <div className="border rounded-lg p-6 shadow-md">
              ...
              <p className="text-sm text-gray-600 mb-4">Receive <span className="font-semibold">1000 C</span>/Month</p>
              <ul className="text-left text-sm text-gray-700 space-y-2">
            ...
            <div className="border rounded-lg p-6 shadow-sm">
              ...
              <p className="text-sm text-gray-500 mb-4">✨ Unlock More Exclusive Discounts</p>
