...
export default async function PersonalityTypePage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      <div className="mx-auto max-w-6xl px-6 pt-12 pb-16 lg:pt-16">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:gap-12">

          {/* Left: character gallery */}
          <div className="lg:sticky lg:top-8 lg:w-[42%] lg:shrink-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <h1 className="text-6xl font-black tracking-tight text-neutral-900 lg:text-7xl">{mbti}</h1>
            ...
            {/* Client: generate buttons + poster + share */}
            <div className="mt-8">
