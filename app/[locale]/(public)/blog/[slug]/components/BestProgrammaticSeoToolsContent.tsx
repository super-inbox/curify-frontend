...
const TOOLS = [
  {
    idx: 1,
    color: 'blue',
    image: '/images/best-programmatic-seo-tools-airops.webp',
    href: 'https://www.airops.com/',
  },
  {
    idx: 2,
    color: 'green',
    image: '/images/best-programmatic-seo-tools-webflow.webp',
    href: 'https://webflow.com/',
  },
  {
    idx: 3,
    color: 'purple',
    image: '/images/best-programmatic-seo-tools-wordpress.webp',
...
export default function BestProgrammaticSeoToolsContent() {
  const t = useTranslations('blog.bestProgrammaticSeoTools')
      ...
      <div className="space-y-6">
            ...
            >
              ...
              <div className="p-6">
                ...
                <ul className="text-sm space-y-1 mb-4">
                  ...
                  <li><strong>Integrations:</strong> {t(`tool${idx}Languages`)}</li>
            ...
            <table className="min-w-full border-collapse text-sm">
              <thead className="bg-gray-100 dark:bg-gray-800">
                <tr>
                  ...
                  <th className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-left">AirOps</th>
                  <th className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-left">Webflow</th>
                  <th className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-left">WordPress + WP All Import</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                ...
                <tr>
                  <td className="border border-gray-300 dark:border-gray-700 px-4 py-2 font-semibold">Integrations</td>
        ...
        >
          ...
          <div className="mt-6">
            ...
            >
              See Curify for programmatic SEO →
            </Link>
          </div>
        </section>
        ...
        <BlogCTACard category="content-automation" slug="best-programmatic-seo-tools" locale={locale} />

        <RelatedBlogs currentSlug="best-programmatic-seo-tools" locale={locale} maxRelated={2} />
      </div>
