...
export function createBlogPostsConfig() {
  ...
  blogsData.forEach((blog) => {
    ...
    const namespaceMap: Record<string, string> = {
      ...
      'ugc-video-translation-scaling-tiktoks-shorts-global-markets': 'ugcVideoTranslationScalingTiktoksShortsGlobalMarkets'
    };
