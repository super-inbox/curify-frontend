...
function SidebarToolItem({
  ...
  return (
    <div className="group flex cursor-pointer items-start gap-3 rounded-xl p-2.5 transition-colors hover:bg-neutral-50">
      <div
              ...
              <div className="rounded-2xl border border-neutral-100 bg-white p-5 shadow-sm">
                ...
                <div className="mt-6 border-t border-neutral-100 pt-4">
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 py-3 text-sm font-semibold text-white shadow-md transition-all hover:bg-blue-700 hover:shadow-lg"
                  >
