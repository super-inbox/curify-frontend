...
// NB: this file is CommonJS (.cjs) and loaded via require() from
// next.config.ts. Do NOT add ESM `import` statements — they throw a
// SyntaxError at load time, the catch in next.config.ts swallows it,
// and Next.js silently drops every redirect in this file. The locale
// list is inlined for that reason. Keep this comment if you re-run
